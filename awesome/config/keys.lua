...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn("rofi -show drun -drun-display-format {name} -theme horizon") end,
              {description = "open rofi", group = "launcher"}),
    awful.key({ modkey,           }, "e", function () awful.spawn(apps.fileexplorer) end,
    ...
    awful.key({ modkey, "Shift" }, "g",     function () beautiful.useless_gap = beautiful.useless_gap - 5 end,
